...
function StayConnected() {
  return (
    <div className="mt-24">
        ...
        <div className='px-4 md:px-12 flex flex-col md:flex-row gap-x-14 mt-8'>
          ...
          <div className='-mt-12'>
              ...
              <input type="text" className='block w-full rounded-lg border-2 border-[#E4E1E1] px-4 py-3.5 text-[19px] font-ssp text-[#011805] pl-10 placeholder:text-[#011805]' placeholder='Enter Your E-mail Address' />
              <button type='button' className='absolute text-[19px] bg-[#00A41A] text-[#FFF] font-ssp right-[50px] px-8 py-3.5 rounded-r-lg rounded-l-[32px]'>Subscribe</button>
              </div>
