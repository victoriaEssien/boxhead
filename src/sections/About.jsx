  ...
  return (
    <div className="mt-24">
        ...
        <div className='px-4 md:px-12 flex flex-col md:flex-row'>
            <div className='-mt-6'>
                <h5 className='text-3xl md:text-2xl font-ssp font-bold text-[#011805] mt-12 md:mt-16 w-full md:w-[645px] leading-normal md:leading-8'>Welcome to Olusanmi&apos;s Studio</h5>
                ...
                <div className='mt-14'>
                <Link className="flex items-center justify-center gap-x-2.5 border border-[#00A41A] w-full md:w-[180px] px-[30px] py-[12px] rounded-[10px]">
                    <p className="text-[19px] font-ssp font-semibold text-[#00A41A]">Read More</p>
                    <img className="" src={VerticalArrow} />
                </Link>
                </div>
            </div>
            <div className='w-11/12 md:w-3/6 md:ml-20 mt-10 md:mt-0 mb-10 flex self-center'>
