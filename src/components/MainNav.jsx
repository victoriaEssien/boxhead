            ...
            <nav className='flex items-center justify-between p-4 lg:px-12' aria-label='Global'>
                <div className='flex lg:flex mr-8'>
                    <Link className='-m-1.5 p-1.5'>
                        <span className='font-rwp font-normal text-[32px] text-[#008916] leading-8'>BOXHEAD</span>
                    </Link>
                </div>
            ...
            <Dialog as='div' className='lg:hidden' open={mobileMenuOpen} onClose={setMobileMenuOpen}>
                ...
                <Dialog.Panel className='fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-white'>
                    <div className="flex items-center justify-between">
                        ...
                        <span className='font-rwp font-normal text-[32px] text-[#008916] leading-8'>BOXHEAD</span>                        </a>
